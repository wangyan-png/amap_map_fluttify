          ...
          try {
            ...
            switch (methodCall.method) {
              case 'Callback::MAOfflineMapDownloadBlock::MAOfflineMapDownloadBlock':
                ...
                // handle the native call
                if (downloadBlock != null) downloadBlock(AmapMapFluttifyIOSAs(args['downloadItem']), (args['downloadStatus'] as int).toMAOfflineMapDownloadStatus(), AmapMapFluttifyIOSAs(args['info']));
                break;
              default:
                throw MissingPluginException('方法${methodCall.method}未实现');
                break;
