...
class MATileOverlay extends NSObject with MAAnnotation, MAOverlay {
  ...
  Future<MAMapRect> get_boundingMapRect() async {
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod("MATileOverlay::get_boundingMapRect", {'__this__': this});
  ...
  Future<void> set_boundingMapRect(MAMapRect boundingMapRect) async {
    await kAmapMapFluttifyChannel.invokeMethod('MATileOverlay::set_boundingMapRect', <String, dynamic>{'__this__': this, "boundingMapRect": boundingMapRect});
          ...
          try {
            ...
            switch (methodCall.method) {
              case 'Callback::void|NSData*#tileData,NSError*#error::void|NSData*#tileData,NSError*#error':
                ...
                if (result != null) result(AmapMapFluttifyIOSAs(args['tileData']), AmapMapFluttifyIOSAs(args['error']));
                break;
              default:
...
extension MATileOverlay_Batch on List<MATileOverlay> {
  ...
  Future<List<MAMapRect>> get_boundingMapRect_batch() async {
    final resultBatch = await kAmapMapFluttifyChannel.invokeMethod("MATileOverlay::get_boundingMapRect_batch", [for (final __item__ in this) {'__this__': __item__}]);
  ...
  Future<void> set_boundingMapRect_batch(List<MAMapRect> boundingMapRect) async {
    await kAmapMapFluttifyChannel.invokeMethod('MATileOverlay::set_boundingMapRect_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {'__this__': this[__i__], "boundingMapRect": boundingMapRect[__i__]}]);
  ...
  Future<List<void>> cancelLoadOfTileAtPath_batch(List<MATileOverlayPath> path) async {
    ...
    // invoke native method
    final resultBatch = await kAmapMapFluttifyChannel.invokeMethod('MATileOverlay::cancelLoadOfTileAtPath_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"path": path[__i__], "__this__": this[__i__]}]);
