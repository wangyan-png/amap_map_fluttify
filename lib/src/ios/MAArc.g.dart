...
class MAArc extends MAShape with MAOverlay, MAAnnotation {
  ...
  Future<MAMapRect> get_boundingMapRect() async {
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod("MAArc::get_boundingMapRect", {'__this__': this});
...
extension MAArc_Batch on List<MAArc> {
  ...
  Future<List<MAMapRect>> get_boundingMapRect_batch() async {
    final resultBatch = await kAmapMapFluttifyChannel.invokeMethod("MAArc::get_boundingMapRect_batch", [for (final __item__ in this) {'__this__': __item__}]);
