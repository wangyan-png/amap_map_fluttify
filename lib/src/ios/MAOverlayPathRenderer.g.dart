...
class MAOverlayPathRenderer extends MAOverlayRenderer  {
  ...
  Future<bool> get_lineDash() async {
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod("MAOverlayPathRenderer::get_lineDash", {'__this__': this});
    return __result__;
  }
  ...
  Future<void> set_lineDash(bool lineDash) async {
    await kAmapMapFluttifyChannel.invokeMethod('MAOverlayPathRenderer::set_lineDash', <String, dynamic>{'__this__': this, "lineDash": lineDash});
...
extension MAOverlayPathRenderer_Batch on List<MAOverlayPathRenderer> {
  ...
  Future<List<bool>> get_lineDash_batch() async {
    final resultBatch = await kAmapMapFluttifyChannel.invokeMethod("MAOverlayPathRenderer::get_lineDash_batch", [for (final __item__ in this) {'__this__': __item__}]);
  ...
  Future<void> set_lineDash_batch(List<bool> lineDash) async {
    await kAmapMapFluttifyChannel.invokeMethod('MAOverlayPathRenderer::set_lineDash_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {'__this__': this[__i__], "lineDash": lineDash[__i__]}]);
