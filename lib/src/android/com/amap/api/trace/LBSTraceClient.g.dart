...
class com_amap_api_trace_LBSTraceClient extends java_lang_Object  {
  ...
  Future<void> queryProcessedTrace(int var1, List<com_amap_api_trace_TraceLocation> var2, int var3, com_amap_api_trace_TraceListener var4) async {
    ...
    // invoke native method
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod('com.amap.api.trace.LBSTraceClient::queryProcessedTrace', {"var1": var1, "var2": var2, "var3": var3, "__this__": this});
  
  
    // handle native call
    MethodChannel('com.amap.api.trace.LBSTraceClient::queryProcessedTrace::Callback@$refId', kAmapMapFluttifyMethodCodec)
          ...
          try {
            ...
            switch (methodCall.method) {
              ...
              case 'Callback::com.amap.api.trace.TraceListener::onTraceProcessing':
                ...
                // handle the native call
                var4?.onTraceProcessing(args['var1'], args['var2'], (args['var3'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList());
                break;
              case 'Callback::com.amap.api.trace.TraceListener::onFinished':
                ...
                // handle the native call
                var4?.onFinished(args['var1'], (args['var2'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList(), args['var3'], args['var4']);
                break;
              default:
  ...
  Future<void> startTrace(com_amap_api_trace_TraceStatusListener var1) async {
    ...
    // invoke native method
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod('com.amap.api.trace.LBSTraceClient::startTrace', {"__this__": this});
  
  
    // handle native call
    MethodChannel('com.amap.api.trace.LBSTraceClient::startTrace::Callback@$refId', kAmapMapFluttifyMethodCodec)
        .setMethodCallHandler((methodCall) async {
          try {
            final args = methodCall.arguments as Map;
            switch (methodCall.method) {
              case 'Callback::com.amap.api.trace.TraceStatusListener::onTraceStatus':
                ...
                // handle the native call
                var1?.onTraceStatus((args['var1'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_trace_TraceLocation>(it))?.toList(), (args['var2'] as List)?.map((it) => AmapMapFluttifyAndroidAs<com_amap_api_maps_model_LatLng>(it))?.toList(), args['var3']);
                break;
              default:
                throw MissingPluginException('方法${methodCall.method}未实现');
                break;
