...
class com_amap_api_maps_InfoWindowAnimationManager extends java_lang_Object  {
  ...
  Future<void> setInfoWindowAnimation(com_amap_api_maps_model_animation_Animation var1, com_amap_api_maps_model_animation_Animation_AnimationListener var2) async {
    ...
    final __result__ = await kAmapMapFluttifyChannel.invokeMethod('com.amap.api.maps.InfoWindowAnimationManager::setInfoWindowAnimation', {"var1": var1, "__this__": this});
  
  
    // handle native call
    MethodChannel('com.amap.api.maps.InfoWindowAnimationManager::setInfoWindowAnimation::Callback@$refId', kAmapMapFluttifyMethodCodec)
